...
pre_train_data_loader_train = DataLoader(Dataset_phonemes_pre_train, batch_size=20,shuffle=True)
...
visualize_confMatrix(save_result_path,test_conf[:-1,:-1], labels_classes_reindex[:-1], 'test-no-LM')
