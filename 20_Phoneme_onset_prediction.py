...
acustic_feature_DF=pd.read_csv(patient_folder+'preprocessed_dataframe_onset.csv')
...
'''' Delay model between phoneme'''
phoneme_delay_model = get_delay_btwn_phoneme(acustic_feature_DF)
